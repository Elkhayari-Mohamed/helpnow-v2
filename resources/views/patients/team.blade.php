        ...
        <div class="mb-18">
            ...
            <div class="row row-cols-1 row-cols-sm-2 row-cols-xl-4 gy-10">
                ...
                <div class="col text-center mb-9">
                    ...
                    <div class="mb-0">
                        <!--begin::Name-->
                        <a href="../../demo1/dist/pages/user-profile/projects.html" class="text-dark fw-bolder text-hover-primary fs-3">Jania Garnbet</a>
                        <!--end::Name-->
                        <!--begin::Position-->
                ...
                <div class="col text-center mb-9">
                    ...
                    <div class="mb-0">
                        <!--begin::Name-->
                        <a href="../../demo1/dist/pages/user-profile/projects.html" class="text-dark fw-bolder text-hover-primary fs-3">James Nilson</a>
                        <!--end::Name-->
                        <!--begin::Position-->
                ...
                <div class="col text-center mb-9">
                    ...
                    <div class="mb-0">
                        <!--begin::Name-->
                        <a href="../../demo1/dist/pages/user-profile/projects.html" class="text-dark fw-bolder text-hover-primary fs-3">Mia Miles</a>
                        <!--end::Name-->
                        <!--begin::Position-->
                ...
                <div class="col text-center mb-9">
                    ...
                    <div class="mb-0">
                        <!--begin::Name-->
                        <a href="../../demo1/dist/pages/user-profile/projects.html" class="text-dark fw-bolder text-hover-primary fs-3">Sophia Miles</a>
                        <!--end::Name-->
                        <!--begin::Position-->
                ...
                <div class="col text-center mb-9">
                    ...
                    <div class="mb-0">
                        <!--begin::Name-->
                        <a href="../../demo1/dist/pages/user-profile/projects.html" class="text-dark fw-bolder text-hover-primary fs-3">Oliver Lucas</a>
                        <!--end::Name-->
                        <!--begin::Position-->
                ...
                <div class="col text-center mb-9">
                    ...
                    <div class="mb-0">
                        <!--begin::Name-->
                        <a href="../../demo1/dist/pages/user-profile/projects.html" class="text-dark fw-bolder text-hover-primary fs-3">Amelia Miles</a>
                        <!--end::Name-->
                        <!--begin::Position-->
                ...
                <div class="col text-center mb-9">
                    ...
                    <div class="mb-0">
                        <!--begin::Name-->
                        <a href="../../demo1/dist/pages/user-profile/projects.html" class="text-dark fw-bolder text-hover-primary fs-3">Liam James</a>
                        <!--end::Name-->
                        <!--begin::Position-->
                        <div class="text-muted fs-6 fw-bold">QA Managers</div>
                        <!--begin::Position-->
