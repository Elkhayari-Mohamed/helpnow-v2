...
@section('content')
    ...
    <div class="card card-flush h-lg-100" id="kt_contacts_main">
        ...
        <div class="card-body pt-5">
            <!--begin::Form-->
            <form method="POST" action="{{ route('doctorsComplete_profile') }}">
                @csrf
                <!--begin::Input group-->
                <div class="mb-7">
                    <!--begin::Label-->
                ...
                <div class="row row-cols-1 row-cols-sm-2 rol-cols-md-1 row-cols-lg-2">
                    ...
                    <div class="col">
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <input id="first_name" class="form-control form-control-lg form-control-solid" type="text"
                                name="first_name" value="" autofocus />
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
                    </div>
                    ...
                    <div class="col">
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <input id="last_name" class="form-control form-control-lg form-control-solid" type="text"
                                name="last_name" value="" autofocus />
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
                    </div>
                ...
                <div class="col">
                    ...
                    <div class="fv-row mb-7">
                        <!--begin::Label-->
                        <label class=" fw-bold fs-6 mb-2">Your Specialitie</label>
                        <select required class="form-control form-control-lg form-control-solid" type="hidden"
                            name="specialitie_name">
                            @foreach ($specialities as $specialitie)
                                <option value={{ $specialitie->name }}>{{ $specialitie->name }} </option>
                            @endforeach
                        </select>
                ...
                <div class="row row-cols-1 row-cols-sm-2 rol-cols-md-1 row-cols-lg-2">
                    ...
                    <div class="col">
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input id="phone" class="form-control form-control-lg form-control-solid" type="text"
                                name="phone" value="" />
                        </div>
                        <!--end::Input group-->
                    </div>
                ...
                <div class="row row-cols-1 row-cols-sm-2 rol-cols-md-1 row-cols-lg-2">
                    ...
                    <div class="col">
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input id="city" class="form-control form-control-lg form-control-solid" type="text"
                                name="city" value="" />
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <div class="w-100">
                                <div class="form-floating border rounded">
                                    <!--begin::Select2-->
                                    <select id="country" class="form-select form-select-solid lh-1 py-3" name="country"
                                        value="" data-kt-ecommerce-settings-type="select2_flags"
                                        ...
                                        <option value="IM"
                                            data-kt-select2-country="assets/media/flags/isle-of-man.svg">Isle
                                            of Man</option>
                ...
                <div class="col">
                    ...
                    <div class="fv-row mb-7">
                        <!--begin::Label-->
                        <label class=" fw-bold fs-6 mb-2">Adresse</label>
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input id="address" class="form-control form-control-lg form-control-solid" type="text"
                            name="address" value="" />
                        <!--end::Input-->
                    </div>
                    <!--end::Input group-->
                ...
                <div class="row row-cols-1 row-cols-sm-2 rol-cols-md-1 row-cols-lg-2">
                    ...
                    <div class="col">
                        ...
                        <div class="fv-row mb-7">
                            <!--begin::Label-->
                            <label class=" fw-bold fs-6 mb-2">Age</label>
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input id="age" class="form-control form-control-lg form-control-solid" type="text"
                                name="age" value="" autofocus />
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
                    </div>
                ...
                <div class="col">
                    ...
                    <div class="fv-row mb-7">
                        ...
                        <input id="notes" class="form-control form-control-lg form-control-solid" type="text"
                            name="notes" value=" " />
                        <!--end::Input-->
                    </div>
                    <!--end::Input group-->
