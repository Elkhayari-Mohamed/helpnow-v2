            ...
            <div class="card">
                <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                    ...
                    <div class="d-flex flex-wrap gap-1">
                        ...
                        <!--end::Filter-->
                        <!--begin::Reload-->
                        <a href="#" class="btn btn-sm btn-icon btn-clear btn-active-light-primary" data-bs-toggle="tooltip"
                    ...
                    <table class="table table-hover table-row-dashed fs-6 gy-5 my-0" id="kt_inbox_listing">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="min-w-80px">
                                    <!--begin::Star-->
                                    <a href="#" class="btn btn-icon btn-color-gray-400 btn-sm btn-active-color-primary"
                                ...
                                <td>
                                    <div class="text-dark mb-1">
                                        ...
                                        <a href="../../demo1/dist/apps/inbox/reply.html" class="text-dark">
                                            ...
                                            <span class="fw-bolder d-none d-md-inine">-</span>
                                            <span class="d-none d-md-inine text-muted">Please make sure that you have one
                                                of the following cards with you when we deliver your order...</span>
                                        </a>
                                        <!--end::Heading-->
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="text-dark mb-1">
                                        <!--begin::Heading-->
                                        <a href="../../demo1/dist/apps/inbox/reply.html" class="text-dark">
                                            <span class="fw-bolder">Your Order #224820998666029 has been
                                                Confirmed</span>
                                            <span class="fw-bolder d-none d-md-inine">-</span>
                                            <span class="d-none d-md-inine text-muted">Your Order #224820998666029 has been
                                ...
                                <td>
                                    <div class="text-dark mb-1">
                                        ...
                                        <a href="../../demo1/dist/apps/inbox/reply.html" class="text-dark">
                                            ...
                                            <span class="fw-bolder d-none d-md-inine">-</span>
                                            <span class="d-none d-md-inine text-muted">Your payment of 4500USD to AirCar
                                                has been authorized and confirmed, thank you your account. This...</span>
                                        </a>
                                        <!--end::Heading-->
                                    </div>
                                    <!--begin::Badges-->
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="text-dark mb-1">
                                        <!--begin::Heading-->
                                        <a href="../../demo1/dist/apps/inbox/reply.html" class="text-dark">
                                            <span class="fw-bolder">Congratulations on your iRun Coach
                                                subscription</span>
                                            <span class="fw-bolder d-none d-md-inine">-</span>
                                            <span class="d-none d-md-inine text-muted">Congratulations on your iRun Coach
                                                subscription. You made no space for excuses and you</span>
                                        </a>
                                        <!--end::Heading-->
                                    </div>
                                </td>
                                ...
                                <td>
                                    <div class="text-dark mb-1">
                                        ...
                                        <a href="../../demo1/dist/apps/inbox/reply.html" class="text-dark">
                                            ...
                                            <span class="fw-bolder d-none d-md-inine">-</span>
                                            <span class="d-none d-md-inine text-muted">Congratulations on your iRun Coach
                                                subscription. You made no space for excuses and you decided on a healthier
                                ...
                                <td>
                                    <div class="text-dark mb-1">
                                        ...
                                        <a href="../../demo1/dist/apps/inbox/reply.html" class="text-dark">
                                            ...
                                            <span class="fw-bolder d-none d-md-inine">-</span>
                                            <span class="d-none d-md-inine text-muted">What you requested can't be arranged
                                                ahead of time but PalmLake said they'll do their best to accommodate you
                                                upon arrival....</span>
                                        </a>
                                        <!--end::Heading-->
                                    </div>
