            ...
            <div class="card-body pt-5">
                ...
                <form method="POST" action="{{ route('doctors.update') }}">
                    ...
                    <div class="row row-cols-1 row-cols-sm-2 rol-cols-md-1 row-cols-lg-2">
                        ...
                        <div class="col">
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <input id="first_name" class="form-control form-control-lg form-control-solid"
                                    type="text" name="first_name" value="{{ $info->first_name }}" autofocus />
                                <!--end::Input-->
                            </div>
                            <!--end::Input group-->
                        </div>
                        ...
                        <div class="col">
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <input id="last_name" class="form-control form-control-lg form-control-solid" type="text"
                                    name="last_name" value="{{ $info->last_name }}" autofocus />
                                <!--end::Input-->
                            </div>
                            <!--end::Input group-->
                        </div>
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <div class="w-100">
                                    <div class="form-floating border rounded">
                                        <!--begin::Select2-->
                                        <select id="country" class="form-select form-select-solid lh-1 py-3"
                                            ...
                                            <option value="SM"
                                                ...
                                                Marino</option>
                                            <option value="ST"
                                                data-kt-select2-country="assets/media/flags/sao-tome-and-prince.svg">Sao
                                                Tome
                                                and Principe</option>
                                            <option value="SA"
                    ...
                    <div class="row row-cols-1 row-cols-sm-2 rol-cols-md-1 row-cols-lg-2">
                        ...
                        <div class="col">
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input id="age" class="form-control form-control-lg form-control-solid"
                                    type="Integer" name="age" value="{{ $info->age }}" autofocus />
                                <!--end::Input-->
                            </div>
                            <!--end::Input group-->
                        </div>
                    ...
                    <div class="col">
                        ...
                        <div class="fv-row mb-7">
                            <!--begin::Label-->
                            <label class=" fw-bold fs-6 mb-2">Specialitie</label>
