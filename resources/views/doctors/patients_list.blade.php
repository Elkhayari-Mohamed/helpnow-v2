                ...
                <div class="modal fade" id="kt_modal_add_user" tabindex="-1" aria-hidden="true">
                    ...
                    <div class="modal-dialog modal-dialog-centered mw-650px">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                <!--begin::Form-->
                                <form method="POST" action="{{ route('doctorsPatients_list') }}">
                                    @csrf
                                    <!--begin::Scroll-->
                                    <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll"
                                        ...
                                        <div class="fv-row mb-7">
                                            <!--begin::Label-->
                                            <label class="required fw-bold fs-6 mb-2">Prescription</label>
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input id="prescription"
                                                class="form-control form-control-lg form-control-solid" type="text"
                                                name="prescription" />
                                            <!--end::Input-->
                                        </div>
                        ...
                        <tr>
                            ...
                            <td class="d-flex align-items-center">
                                ...
                                <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
                                    <a>
                                        <div class="symbol-label">
                                            @if ($list->patient->img == true)
                                                <img src="{{ $list->patient->img }}" alt="Emma Smith" class="w-100" />
                                            @else
                                                <img src='assets/media/avatars/300-1.jpg' alt="Patient"
                                                    class="w-100" />
                                            @endif
                                        </div>
                                    </a>
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <a href="/doctors/patient_info/{{ $list['id'] }}"
                                        class="text-gray-800 text-hover-primary mb-1">{{ $list->patient->first_name . ' ' . $list->patient->last_name }}</a>
                                    <span>{{ $list->patient->email }}</span>
                                </div>
                                <!--begin::User details-->
                            </td>
                            <!--end::User=-->
                            <td>
                                <div class="badge badge-light fw-bolder">
                                    ...
                                    @if ($list->status == null)
                                        <div class="text-warning">waiting for acceptation</div>
                            ...
                            <td style="padding-left: 2rem">
                                <a href="doctors/consultation_request/{{ $list['id'] }}"
                            ...
                            <td class="text-end">
                                ...
                                <div class="px-7 py-5">
                                    @if ($list->status == 0)
                                        ...
                                        <a href="{{ route('status_update', ['cons_id' => $list->id, 'status' => 2]) }}"
                                            class="btn btn-light-primary me-3">
                                            <span class="indicator-label">Denied</span>
                                            <span class="indicator-progress">Please wait...
                                                <span class="spinner-border spinner-border-sm align-middle ms-2">
                                                </span>
                                            </span>
                            ...
                            @if ($list->status == 1 and $list->payed == 1)
                                <td>
                            ...
                            @if ($list->status == 1 and $list->payed == 1)
                                <td>
                                    <a href="live/{{ $list['link'] }}" class="btn btn-sm btn-light-primary">
                                        <!--begin::Svg Icon | path: icons/duotune/arrows/arr012.svg-->
