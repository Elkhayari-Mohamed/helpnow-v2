            ...
            <div class="card-body p-0">
                ...
                <div class="px-9 pt-7 card-rounded h-275px w-100 bg-success">
                    ...
                    <div class="d-flex text-center flex-column text-white pt-8">
                        ...
                        <span class="fw-bolder fs-2x pt-1">{{ $balance }} Dh</span>
                    </div>
                    <!--end::Balance-->
                </div>
                <!--end::Header-->
                        ...
                        <div class="d-flex mb-7">
                            ...
                            <div class="d-flex align-items-center flex-wrap flex-grow-1 mt-n2 mt-lg-n1">
                                ...
                                <div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 pe-3">
                                    <a
                                        class="fs-5 text-gray-800 text-hover-primary fw-bolder">{{ $consultation->consultation_date }}</a>
                                ...
                                <div class="text-end py-lg-0 py-2">
                                    @if ($consultation->ordonnances->count() >= 1)
                                        <a href="{{ route('patientsOrdonnance', ['id' => $consultation->id]) }}"
                                            class="btn btn-light bnt-active-light-primary btn-sm text-success">View
                                            Ordonnance </a>
